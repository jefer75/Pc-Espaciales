...
?>		
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-font zmdi-hc-fw"></i> clientes</h1>
			</div>
			<p class="lead">En esta pantalla puedes visualizar y registrar nuevos clientes para el aplicativo.</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
