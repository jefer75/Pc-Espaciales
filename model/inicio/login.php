...
<body class="cover" style="background-image: url(../../img/fondos/login.jpeg);">
	...
	<form method="POST" action="../../controller/inicio.php" autocomplete="off" class="full-box logInForm">
		...
		<div class="form-group text-center">
			<input type="submit" name="inicio" value="Iniciar sesión" class="btn btn-raised btn-danger">
        </div>
        <a style="color: white; text-decoration: none;" href="register.php">Registrarse</a>
	</form>
	<!--====== Scripts -->
