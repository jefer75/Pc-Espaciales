...
?>
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-font zmdi-hc-fw"></i> Inventario <small>Mouse</small></h1>
			</div>
			<p class="lead">En esta pantalla puedes visualizar las diferentes referencias de mouse que tíenes en tu inventario.</p>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
							...
							<div class="table-responsive">
								<table class="table table-hover text-center">
                                    ...
                                    $con_productos = $con->prepare("SELECT productos.*, estados.estado FROM productos
                                                                    ...
                                                                    Where productos.id_tipo_pro=5 ANd productos.id_estado=1");
